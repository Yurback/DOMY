...
--
-- Хост: 127.0.0.1
-- Время создания: Фев 25 2019 г., 19:03
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `putAnswer` (IN `P_ID_USER` INTEGER, IN `P_ID_QUESTION` INTEGER, IN `P_ID_ANSWER` INTEGER, IN `P_INFO` VARCHAR(1024), IN `P_SCALE_VALUE` FLOAT)  BEGIN
...
(24, 1, 'Обращаете ли внимание на парковочные места?', NULL, 0, 0, '2019-02-17 23:34:29', NULL),
(25, 1, 'Стоит ли смотреть квартиру с другом или лучше в одиночку?', NULL, 0, 0, '2019-02-17 23:48:50', NULL),
(26, 1, 'Как вы считаете, является ли квартира частью вашего имиджа?', NULL, 0, 0, '2019-02-17 23:48:50', NULL),
(27, 1, 'Обратили ли вы внимание на планировку района?', NULL, 0, 0, '2019-02-17 23:48:50', NULL),
(28, 1, 'Проверяете ли вы количество лет, в течение которых квартира была в собственности? ', NULL, 0, 0, '2019-02-17 23:48:50', NULL),
(29, 1, 'В какое время лучше осматривать квартиру?', NULL, 0, 0, '2019-02-17 23:48:50', NULL),
(30, 1, 'Нужно ли при покупке вторички проверять долю владения собственника?', NULL, 0, 0, '2019-02-17 23:48:50', NULL),
(31, 1, 'Знаете ли вы, какая сторона у квартиры считается самой \"худшей\"? ', NULL, 0, 0, '2019-02-17 23:48:50', NULL),
(32, 1, 'Как вы думаете, что важнее для большинства: потребительские характеристики или собственные эмоции при покупке новой квартиры? ', NULL, 0, 0, '2019-02-17 23:48:50', NULL),
(33, 1, 'Знаете ли вы, как проверить тягу в вентиляционном коробе?', NULL, 0, 0, '2019-02-17 23:48:51', NULL),
(34, 1, 'Какая высота потолка считается хорошей?', NULL, 0, 0, '2019-02-17 23:48:51', NULL),
(35, 1, 'Какая лицевая отделка дома самая худшая?', NULL, 0, 0, '2019-02-17 23:48:51', NULL),
(36, 1, 'Наилучшими для покупки квартиры считаются этажи:', NULL, 0, 0, '2019-02-17 23:48:51', NULL),
(37, 1, 'Знаете ли вы, как проверить, делал ли предыдущий хозяин перепланировку? ', NULL, 0, 0, '2019-02-17 23:48:51', NULL),
(38, 1, 'Могут ли претендовать на квартиру прописанные в ней третьи лица, если вы уже приобрели ее в собственность?', NULL, 0, 0, '2019-02-17 23:48:51', NULL),
(39, 1, 'Что лучше: небольшая и функциональная квартира или квартира со свободными неиспользуемыми метрами?', NULL, 0, 0, '2019-02-17 23:48:51', NULL),
(40, 1, 'Входит ли разводка электричества в черновую отделку новостройки?', NULL, 0, 0, '2019-02-17 23:48:51', NULL),
(41, 1, 'Стоит ли покупать квартиру в бывшем долгострое?', NULL, 0, 0, '2019-02-17 23:48:51', NULL),
(42, 1, 'Насколько быстро человек привыкает к новой квартире?', NULL, 0, 0, '2019-02-17 23:48:51', NULL),
(43, 1, 'На сколько процентов увеличивается стоимость жилья после ввода?', NULL, 0, 0, '2019-02-17 23:48:51', NULL),
(44, 1, 'Вредно ли жить в километре от ТЭЦ?', NULL, 0, 0, '2019-02-17 23:48:51', NULL),
(45, 1, 'Что хуже для экологии района: транспорт или ТЭЦ?', NULL, 0, 0, '2019-02-17 23:48:51', NULL),
(46, 1, 'Больше всего производств в Москве расположено на:', NULL, 0, 0, '2019-02-17 23:48:51', NULL),
(47, 1, 'Есть ли отличие у слов \"Свалка\" и \"Полигон ТБО\" (когда вы присматриваете район):', NULL, 0, 0, '2019-02-17 23:48:51', NULL),
(48, 1, 'Отличается ли качество воды в разных районах и соответствует ли оно нормативам?', NULL, 0, 0, '2019-02-17 23:48:51', NULL),
(49, 1, 'Насколько дороже экологически чистые районы по отношению к загрязненным?', NULL, 0, 0, '2019-02-17 23:48:51', NULL);
...
--
-- AUTO_INCREMENT для таблицы `stop_list`
--
ALTER TABLE `stop_list`
