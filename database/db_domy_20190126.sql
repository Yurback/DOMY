...
--
-- Хост: 127.0.0.1
-- Время создания: Янв 26 2019 г., 22:30
...
-- Процедуры
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_answer` (IN `P_ID_Q` INTEGER, IN `P_ID_TREE` INTEGER)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_question` (IN `P_ID_Q` INTEGER, IN `P_ID_A` INTEGER, IN `P_ID_TREE` INTEGER)  BEGIN
