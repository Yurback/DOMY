...
--
-- Хост: 127.0.0.1
-- Время создания: Фев 25 2019 г., 21:51
...
CREATE DEFINER=``@`localhost` PROCEDURE `getQuestion` (IN `P_ID_TREE` INTEGER, IN `P_ID_Q` INTEGER, IN `P_ID_A` INTEGER)  SQL SECURITY INVOKER
...
CREATE DEFINER=``@`localhost` PROCEDURE `getQuestionsCount` (IN `p_id_tree` INTEGER, IN `p_id_level` INTEGER)  SQL SECURITY INVOKER
BEGIN
  select count(*) as QUESTION_COUNT 
  from SPR_QUESTION_TREE join SPR_QUESTION on SPR_QUESTION_TREE.ID_PARENT = SPR_QUESTION.ID
...
(1, 1, 'Что для вас важно при выборе квартиры (поставьте балл от 1 до 10)?', NULL, 0, 1, 0, '2019-01-16 22:32:34', '2019-02-25 23:00:42'),
(2, 1, 'Важен ли фактор близости к работе?', NULL, 0, 0, 0, '2019-01-16 23:11:46', '2019-02-25 23:00:42'),
(3, 1, 'За какую сумму вы планируете приобрести квартиру?', NULL, 0, 0, 0, '2019-01-16 23:12:48', '2019-02-25 23:00:42'),
(4, 1, 'Нуждаетесь ли вы в привлечении ипотечного кредита?', NULL, 0, 0, 0, '2019-01-16 23:14:26', '2019-02-25 23:00:42'),
(5, 1, 'Важно ли для вас сопровождение риэлтора?', NULL, 0, 0, 0, '2019-01-16 23:15:13', '2019-02-25 23:00:42'),
(6, 1, 'Какое максимальное время вы готовы уделить поиску квартиры?', NULL, 0, 0, 0, '2019-01-16 23:15:51', '2019-02-25 23:00:42'),
(7, 1, 'Какие еще требования вы предъявляете к квартире?', NULL, 0, 0, 0, '2019-01-17 22:55:05', '2019-02-25 23:00:42'),
